...
trait UserNotify
{
    public static function notifyToUser()
    {
        return [
            ...
            'activePlanUser'         => 'Active Plan Users',
            'notActivePlanUser'      => 'Not Active Plan Users',
            'neverPlanPurchaseUser'  => 'Never Plan Purchase Users',
    ...
    public function scopeActivePlanUser($query)
    {
        return $query->whereHas('planHistory');
    }

    public function scopeNotActivePlanUser($query)
    {
        return $query->whereDoesntHave('planHistory');
    }

    public function scopeNeverPlanPurchaseUser($query)
    {
        return $query->where('plan_expires_at', NULL);
    }
