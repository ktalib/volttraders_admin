                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="frontend-error">
                            <img class="frontend-error__thumb" src="{{ asset('assets/errors/images/419.png') }}" alt="image">
                            <div class="frontend-error__content mt-4">
                                <h2 class="title mt-0">@lang('Sorry! Your session has expired')</h2>
                                <p class="description mt-2">@lang('Please go back and refresh your browser and try again.')</p>
