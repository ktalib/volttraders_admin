                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="frontend-error">
                            <img class="frontend-error__thumb" src="{{ asset('assets/errors/images/500.png') }}" alt="image">
                            <div class="frontend-error__content mt-4">
                                <h2 class="title mt-0">@lang('Sorry! Internal server error')</h2>
                                <p class="description mt-2">@lang('Something went wrong on our end. We\'re working on fixing it.')</p>
