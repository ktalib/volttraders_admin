...
<body class="{{ request()->is('admin*') ? '' : 'frontend-body' }}">
    <!-- error-404 start -->
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="frontend-error">
                        <img class="frontend-error__thumb" src="{{ asset('assets/errors/images/404.png') }}" alt="image">
                        <div class="frontend-error__content mt-4">
                            <h2 class="title mt-0">@lang('Page not found')</h2>
                            <p class="description mt-2">@lang('Page you are looking for doesn\'t exist or an other error ocurred') <br> @lang('or temporarily unavailable.')</p>
