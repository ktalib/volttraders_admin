	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-6">
						<img src="{{ frontendImage('blog', $blog->data_values->blog_image_1,'800x800') }}" class="w-100">
					</div>
					<div class="col-md-6">
						<img src="{{ frontendImage('blog', $blog->data_values->blog_image_2,'800x800') }}" class="w-100">
					</div>
					<p class="mt-2">
