...
@section('content')
    <div class="market-overview section-bg py-120 mt-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap flex-between gap-3">
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        if (resp.currencies.length <= 0) {
                            ...
                            $('.load-more-market-list').parent().addClass('d-none');
                        ...
                        $('.load-more-market-list').parent().removeClass('d-none');
