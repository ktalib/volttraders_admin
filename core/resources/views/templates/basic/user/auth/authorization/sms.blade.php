...
@section('content')
    <section class="main-section py-120">
        <div class="container">
                ...
                <div class="verification-code-wrapper">
                    <div class="verification-area">
                        ...
                        <form action="{{ route('user.verify.mobile') }}" method="POST" class="submit-form">
                            @csrf
                            <p class="verification-text mb-2">@lang('A 6 digit verification code sent to your mobile number') : +{{ showMobileNumber(auth()->user()->mobileNumber) }}</p>
