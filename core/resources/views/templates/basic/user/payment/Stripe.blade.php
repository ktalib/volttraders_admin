                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text bg--gradient border-0 text-white"><i class="fas fa-font"></i></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text bg--gradient border-0 text-white"><i class="fas fa-credit-card"></i></span>
                                    </div>
                                </div>
                            </div>
