    ...
    <div class="row justify-content-end gy-4">
        ...
        <div class="col-12">
            <div class="dashboard-card">
                <table class="table {{ $orders->count() ? 'table--responsive--md' : 'table--empty' }}">
                    @php
                                ...
                                <td>
                                    <div class="order--amount-rate-wrapper">
                                        <span class="order--amount d-block">
                                            <span
                                                class="order--amount-value">{{ showAmount($order->amount, 8, currencyFormat: false) }}</span>
                                        ...
                                        <span class="order--rate d-block">
                                            <span
                                                class="order--rate-value">{{ showAmount($order->rate, 8, currencyFormat: false) }}</span>
                                            @if ($order->status == Status::ORDER_OPEN)
                                                <span class="amount-rate-update" data-order='@json($order->only('amount', 'rate', 'id'))'
