                ...
                <form action="{{ route('admin.gateway.automatic.update', $gateway->code) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <input disabled type="hidden" name="currency[{{ $currencyIndex }}][currency]" class="currencySymbol">
                            <div class="payment-method-header">
                                <div class="content">
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
    ...
    <script>
        (function($) {
            ...
            $('.newCurrencyBtn').on('click', function() {
                ...
                form.find('.currencySymbol').val(currency);
            ...
            $('.symbl').on('input', function() {
                ...
                $(this).parents('.payment-method-body').find('.currencySymbol').text(curText);
            });
