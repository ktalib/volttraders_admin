                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-sm-6">
                                <label>@lang('Conversion Charge')</label>
                                <div class="input-group">
                                    <input class="form-control" type="number" step="any" min="0" name="conversion_charge" required value="{{ getAmount(gs('conversion_charge')) }}">
