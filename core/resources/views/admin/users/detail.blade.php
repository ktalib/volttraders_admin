        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.order.history', $user->id) }}" title="Total Order" icon="las la-list" value="{{ $totalOrder }}" bg="indigo" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.trade.history', $user->id) }}" title="Total Trade" icon="las la-exchange-alt" value="{{ $totalTrade }}" bg="17" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.deposit.list', $user->id) }}" title="Total Deposits" icon="las la-wallet" value="{{ $totalDeposit }}" bg="8" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.withdraw.data.all', $user->id) }}" title="Total Withdrawals" icon="la la-bank" value="{{ $totalWithdrawals }}" bg="6" type="2" />
                </div>
            </div>
